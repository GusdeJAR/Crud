...
const UpdateSeriesModal = ({UpdateSeriesShowModal, setUpdateSeriesShowModal}) => {
    ...
    const formik = useFormik({
        ...
        initialValues: {
            IdAlmacenOK: SeriesValues.IdAlmacenOK,
            Serie: SeriesValues.Serie,
            Placa: SeriesValues.Placa,
            Observacion: SeriesValues.Observacion,
        },
        ...
        onSubmit: async (values) => {
            ...
            try {
                ...
                //await putSeries(Serie);
                setMensajeExitoAlert("Series editado Correctamente");
            } catch (e) {
                setMensajeExitoAlert(null);
